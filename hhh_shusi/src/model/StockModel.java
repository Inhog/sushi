...
public class StockModel {
	...
	public void insert(StockVO stock) {
		...
		try {
			...
			ps.executeUpdate();
			ps.close();
			// System.out.println(stock.getMaterialCode());
			// System.out.println(stock.getQuantity());
			// System.out.println(stock.getExpiredDate());
	...
	// public ArrayList searchData(String matName.getText()) {
	// ArrayList<String> list = new ArrayList<>();
	// String sql = "SELECT FROM 테이블명 ( 조인 ) WHERE 자재컬럼명 LIKE '%"+ + %'"
	//
	// }
	// }
